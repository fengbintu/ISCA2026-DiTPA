...
from data_process.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_baseact_transform_delta, droid_baseact_transform_delta_state, droid_baseact_transform_delta_state_with_trajid, droid_baseact_transform_delta_state1, droid_finetuning_transform, rand_swap_exterior_images, Calvin_finetuning_transform
from data_process.rlds.utils.data_utils import (
...
def bridge_orig_dataset_transform_state(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from data_process.rlds import traj_transforms
    for key in trajectory.keys():
        if key == "traj_metadata":
            continue
        elif key == "observation":
