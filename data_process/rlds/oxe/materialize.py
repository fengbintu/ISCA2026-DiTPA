...
from data_process.overwatch import initialize_overwatch
from data_process.rlds.oxe.configs import OXE_DATASET_CONFIGS, ActionEncoding
from data_process.rlds.oxe.transforms import OXE_STANDARDIZATION_TRANSFORMS
...
def get_oxe_dataset_kwargs_and_weights(
    ...
    for d_name, d_weight in filtered_mixture_spec:
        try:
            if d_name in OXE_DATASET_CONFIGS:
                ...
                data_kwargs = make_oxe_dataset_kwargs(
                    'bridge_orig',
                    data_root_dir,
                    load_camera_views,
                    load_depth,
                ...
                data_kwargs['name'] = d_name
                per_dataset_kwargs.append(data_kwargs)
